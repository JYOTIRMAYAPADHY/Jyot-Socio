...
class CreateProfile extends Component {
  ...
  render() {
    ...
    //for option
    const options = [
      { label: "* Select Your Professional Status", value: 0 }, //put * if required
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <SelectListGroup
                  ...
                  options={options}
                  error={errors.status}
                  info="Choose your respective professional status"
                />
                <TextFieldGroup
                  placeholder="Company"
                  name="company"
                ...
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eg. New Delhi, India)"
                />
                <TextFieldGroup
                  placeholder="Skills"
                  name="skills"
                ...
                />
                <TextAreaFieldGroup
                  placeholder="Short and Attractive Bio"
                  name="bio"
