...
//access Public
////Can make it private by adding the passpoprt
...
//access Private
//// IF want to make different routes for user and profile for deleting we can make it here.
router.delete(
  "/",
  passport.authenticate("jwt", { session: false }),
  (req, res) => {
